...
$plugin_tx['translator']['syscheck_extension']="die PHP-Erweiterung '%s' geladen ist";
$plugin_tx['translator']['syscheck_fail']="Fehler";
$plugin_tx['translator']['syscheck_message']="Prüfe, dass %1\$s … %2\$s";
$plugin_tx['translator']['syscheck_phpversion']="die PHP-Version ≥ %s";
$plugin_tx['translator']['syscheck_plugin']="das CMSIMPLE_XH Plugin '%s' installiert ist";
$plugin_tx['translator']['syscheck_success']="OK";
$plugin_tx['translator']['syscheck_title']="System-Prüfung";
$plugin_tx['translator']['syscheck_warning']="Warnung";
$plugin_tx['translator']['syscheck_writable']="'%s' schreibbar ist";
$plugin_tx['translator']['syscheck_xhversion']="die CMSimple_XH-Version ≥ %s";
